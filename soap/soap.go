...
func (s *Client) CallContext(ctx context.Context, soapAction string, request, response interface{}, faultResponse interface{}) error {
	return s.call(ctx, soapAction, request, response, faultResponse)
}

// Call performs HTTP POST request
func (s *Client) Call(soapAction string, request, response interface{}, faultResponse interface{}) error {
	return s.call(context.Background(), soapAction, request, response, faultResponse)
}

func (s *Client) call(ctx context.Context, soapAction string, request, response interface{}, faultResponse interface{}) error {
	...
	respEnvelope.Body = SOAPBody{Content: response, Fault: &SOAPFault{Detail: faultResponse}}
